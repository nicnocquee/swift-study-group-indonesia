              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      Ajukan topik yang ingin dipresentasikan ke komunitas lalu
                      komunitas akan vote untuk memilih yang presentasi di
                      minggu ini.
                    </div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      Kalau terpilih, kamu dapat presentasi maximum 30 menit.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      Presenter akan mendapatkan hadiah Rp. 100.000,-. *
                      <p className="text-sm mt-4">
                        Syarat dan ketentuan
                        <ul className=" list-disc list-inside">
                          <li>
                            Tidak berlaku untuk karyawan Hyperjump Technology
                          </li>
                          <li>Hanya berlaku untuk yang tinggal di Indonesia</li>
                          <li>
                            Hadiah hanya untuk 4 presenter yang berbeda tiap
                            bulannya.
                          </li>
                          <li>
              ...
              <div className="relative flex flex-col text-center lg:text-right  mt-20">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img
                      className="md:max-w-none mx-auto rounded"
                      src={require("../images/features-home-bg-02.png")}
                      width="500"
                      height="375"
                      alt="Features bg"
                    />
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img
                      className="md:max-w-none mx-auto rounded"
                      src={require("../images/features-home-bg-03.png")}
                      width="500"
                      height="375"
                      alt="Features bg"
                    />
