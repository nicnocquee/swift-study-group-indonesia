    ...
    <div className="md:flex-grow">
      ...
      <div className="text-lg text-gray-600">
        ...
        <figure className="mb-8">
          <img className="w-full rounded" src={require('../images/docs-image-01.png')} width="768" height="390" alt="Docs 01" />
        </figure>
        <p className="mb-8">
        ...
        <figure className="mb-8">
          <img className="w-full rounded" src={require('../images/docs-image-02.png')} width="768" height="390" alt="Docs 02" />
        </figure>
        <p className="mb-8">
